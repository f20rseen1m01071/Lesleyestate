...
if (!class_exists('dot')){
    class dot{
        ...
        public object $cookie; // Reserved framework public variable for Cookie Class.
        ...
        public function load($type,
            ...
            foreach ($data as $key => $class){
                ...
                include_once($type == 'classes'
                        ? $this->paths->abs.'/framework/includes/'.$file.'.php'
                        : $file);
        ...
        /*
         * Displays assets files in an HTML page.
         *
         * @usage
         ...
         *
         * @return
         *      Add assets (CSS, CSS code, JavaScript, JavaScript code) to a page.
         *
         * @return_details
         *        -
         *
        ...
        public function sanitize($variable,
            ...
            if (is_array($variable)){
                foreach ($variable as $key => $item){
                    $variable[$key] = $DOT->sanitize($item,
                                                     $type);
                }
                ...
                switch ($type){
                    case 'float':
                        ...
                        break;
                    case 'html':
                        $variable = wp_kses_post($variable);
                        break;
                    case 'int':
